...
--   V20260526_01  prize stock + draw_log
--   V20260526_02  pity / queue / logistics / fragments / activities
--   V20260526_03  activity admin menu
--   V20260526_04  fragment SKU admin menu
--   V20260526_05  probability_history
--
...
CREATE TABLE `mystery_box` (
  ...
  `legendary_rate` int NOT NULL DEFAULT '13' COMMENT '超神概率(万分比)',
  `hidden_rate` int NOT NULL DEFAULT '746' COMMENT '隐藏概率(万分比)',
  `general_rate` int NOT NULL DEFAULT '9241' COMMENT '普通概率(万分比)',
...
INSERT INTO `mystery_box` VALUES ('defb40ceb03740068907138adecaf1a3','2024-03-16 13:29:45.848413','2024-08-26 22:55:14.390279','0f07d638f1bc401188d86dc650ab06a7','0f07d638f1bc401188d86dc650ab06a7','VOCALOID 唱响未来之声！','33','预售',2.00,13,746,9241,'https://my-community.oss-cn-qingdao.aliyuncs.com/20240815142657c0e92113-3d4b-46a8-a69e-e5bc3bb4b9cd_28c16457add5ca49707fd437dd56c71c.png@344w_344h.png','74533bda5c964f569b3f5ad4803c7068'),('ebf8f84d60814944a847e0de4bb1d8b4','2024-03-16 13:24:13.168023','2024-08-26 15:32:17.941637','0f07d638f1bc401188d86dc650ab06a7','0f07d638f1bc401188d86dc650ab06a7','一见倾心的手办','一见倾心的手办','预售',15.00,13,746,9241,'https://arttalks.oss-cn-beijing.aliyuncs.com/20240826151931c55d7389a8438c7146d1dfb9e5ace76e.png','321d4800cad94b06a2176c05d4949f3c');
...
INSERT INTO `user` VALUES ('0f07d638f1bc401188d86dc650ab06a7','2024-01-10 10:48:02.758735','2024-08-26 16:49:43.361822','起凡','https://arttalks.oss-cn-beijing.aliyuncs.com/20240826164940nyjzi7tDDR7Rfd49cc38490fec6c95a93ca6adbaffc1.jpeg','PRIVATE','13656987994','$2a$10$pl/GmO3mDaqWjBtmfXzppOFQwnW/jlinORR6.83Lo7QdTuU4uh5AG','NORMAL',0.00),('4b2cdd272a3d4507a38b05fef41ef4f0','2024-03-14 10:40:44.266051','2024-03-14 16:43:43.574057','起凡2',NULL,'MALE','1365698799','123456','NORMAL',0.00),('9426415c-8254-46dd-95fe-35fb4c307713','2024-01-18 20:25:42.052245','2024-01-18 20:27:01.505872','默认用户',NULL,'FEMALE','13656987995','$2a$10$xp1LPOARpDbUPhNLtjfQMeDWgWS3KRM/7wB4pbya1c9IxVECh.Dv2','NORMAL',0.00),('ad9bff77beb342d091897e69e0a707dd','2024-03-14 15:50:09.144352','2024-03-14 16:43:43.633433','起凡3',NULL,'MALE','1365698790','123456','NORMAL',0.00),('c3a27b84683e4869a38d3c010a16386a','2024-03-14 10:41:45.351397','2024-03-14 16:43:43.441625','起凡3',NULL,'MALE','1365698791','123456','NORMAL',0.00);
...
CREATE TABLE `user_balance_log` (
  ...
  `related_order_id` varchar(36) NOT NULL COMMENT '关联订单id',
  `remark` varchar(255) NOT NULL COMMENT '备注',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='用户余额变动日志';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `mystery_box_win_rule`
--

DROP TABLE IF EXISTS `mystery_box_win_rule`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `mystery_box_win_rule` (
  `id` varchar(32) NOT NULL,
  `created_time` datetime(6) NOT NULL,
  `edited_time` datetime(6) NOT NULL,
  `creator_id` varchar(32) NOT NULL,
  ...
  `mystery_box_id` varchar(32) NOT NULL COMMENT '目标盲盒id',
  `product_id` varchar(32) NOT NULL COMMENT '指定中奖商品id',
  `remaining_count` int NOT NULL COMMENT '剩余生效次数',
  `enabled` tinyint(1) NOT NULL COMMENT '是否启用',
  `approved` tinyint(1) NOT NULL COMMENT '是否审批通过',
  `approved_by_id` varchar(32) DEFAULT NULL COMMENT '审批人',
  `approved_time` datetime(6) DEFAULT NULL COMMENT '审批时间',
  `remark` varchar(255) NOT NULL COMMENT '备注',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='指定中奖规则';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mystery_box_win_rule`
--

LOCK TABLES `mystery_box_win_rule` WRITE;
/*!40000 ALTER TABLE `mystery_box_win_rule` DISABLE KEYS */;
/*!40000 ALTER TABLE `mystery_box_win_rule` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mystery_box_win_hit_log`
--

DROP TABLE IF EXISTS `mystery_box_win_hit_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `mystery_box_win_hit_log` (
  `id` varchar(32) NOT NULL,
  `created_time` datetime(6) NOT NULL,
  `edited_time` datetime(6) NOT NULL,
  `creator_id` varchar(32) NOT NULL,
  `editor_id` varchar(32) NOT NULL,
  `rule_id` varchar(32) NOT NULL COMMENT '命中的规则id',
  `user_id` varchar(32) NOT NULL COMMENT '目标用户id',
  `mystery_box_order_id` varchar(32) NOT NULL COMMENT '盲盒订单id',
  `mystery_box_order_item_id` varchar(32) NOT NULL COMMENT '盲盒订单项id',
  `mystery_box_id` varchar(32) NOT NULL COMMENT '盲盒id',
  `original_product_id` varchar(32) NOT NULL COMMENT '原始中奖商品id',
  `designated_product_id` varchar(32) NOT NULL COMMENT '指定中奖商品id',
  `remark` varchar(255) NOT NULL COMMENT '备注',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='指定中奖命中日志';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mystery_box_win_hit_log`
--

LOCK TABLES `mystery_box_win_hit_log` WRITE;
/*!40000 ALTER TABLE `mystery_box_win_hit_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `mystery_box_win_hit_log` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `mystery_box_win_rule_op_log`
--

DROP TABLE IF EXISTS `mystery_box_win_rule_op_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `mystery_box_win_rule_op_log` (
  `id` varchar(32) NOT NULL,
  `created_time` datetime(6) NOT NULL,
  `edited_time` datetime(6) NOT NULL,
  `creator_id` varchar(32) NOT NULL,
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='指定中奖规则操作审计日志';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `mystery_box_win_rule_op_log`
--

LOCK TABLES `mystery_box_win_rule_op_log` WRITE;
/*!40000 ALTER TABLE `mystery_box_win_rule_op_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `mystery_box_win_rule_op_log` ENABLE KEYS */;
UNLOCK TABLES;
