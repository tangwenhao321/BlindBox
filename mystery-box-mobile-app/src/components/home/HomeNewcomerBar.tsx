...
const newcomerBarGradient = [colors.brand, colors.brandGradientEnd, colors.newcomerBarGradientEnd] as const;
...
function buildNewcomerBarStyles(colors: ThemeColors) {
  ...
  return StyleSheet.create({
    ...
    title: { color: colors.textOnBrand, fontSize: typography.body, fontWeight: "900" },

    sub: { color: "rgba(255,255,255,0.85)", fontSize: typography.micro, fontWeight: "600" },
    ...
    btnText: { color: colors.newcomerBarCtaText, fontWeight: "900", fontSize: typography.caption },
