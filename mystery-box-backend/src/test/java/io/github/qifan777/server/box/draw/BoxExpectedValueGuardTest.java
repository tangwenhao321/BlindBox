...
class BoxExpectedValueGuardTest {
    ...
    void acceptsProfitableConfig() {
        Product legendary = product(DictConstants.QualityType.LEGENDARY, "500", null);
        Product hidden = product(DictConstants.QualityType.HIDDEN, "100", null);
        Product general = product(DictConstants.QualityType.GENERAL, "10", null);
    ...
    void prefersCostPriceOverRetail() {
        Product legendary = product(DictConstants.QualityType.LEGENDARY, "10000", "20");
        Product general = product(DictConstants.QualityType.GENERAL, "10", "1");
    ...
    void rejectsWhenEvExceedsMargin() {
        Product legendary = product(DictConstants.QualityType.LEGENDARY, "10000", null);
        Product general = product(DictConstants.QualityType.GENERAL, "10", null);
        assertThrows(BusinessException.class, () -> guard.assertProfitable(
                new BigDecimal("100"),
                5000,
    ...
    private static Product product(DictConstants.QualityType tier, String price, String cost) {
